...
const Footer = () => {
  return (
    <div className="flex w-full h-screen bg-zinc-800 p-20">
      <div className='w-1/2 h-full flex flex-col justify-between font-["fg"]'>
      ...
      <div className="w-1/2">
        <h1 className="text-[7vw] font-['fg'] uppercase leading-none">
          Presentations
        </h1>
